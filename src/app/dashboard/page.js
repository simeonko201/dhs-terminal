...
export default function Dashboard() {
  ...
  // Fetch roster ordered by numeric rank level (highest to lowest)
      ...
      <div className="flex flex-1 z-10">
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            {/* TAB 1: PERSONNEL & CHAIN OF COMMAND */}
            {activeTab === 'personnel' && (
              <div className="space-y-6">
                ...
                {/* GENERATED CREDENTIALS ALERT BOX */}
                {generatedCredentials && (
                  <div className="bg-emerald-950/40 border border-emerald-500/50 p-4 rounded-lg space-y-2 font-mono text-xs">
                    ...
                    <p className="text-[10px] text-slate-400">
                      Copy the generated password above and send it to the agent via Discord.
                    </p>
                  </div>
                )}

                {/* CHAIN OF COMMAND ROSTER TABLE */}
              ...
              <div className="space-y-6">
                ...
                <form onSubmit={handleAddBlacklist} className="bg-slate-900/80 border border-red-900/40 p-4 rounded-lg space-y-4 backdrop-blur-sm">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <input
                      type="text"
                      placeholder="Duration (e.g. Permanent, 30 Days)"
